...
!!! question "1 - 1. Entendendo a Batalha (Básico 1)"
    **Contexto:** 
...
!!! question "2 - 2. Como isso afeta o Compilador C/C++? (Básico 2)"
    **Contexto:** 
...
!!! question "3 - Resumo Prático (Intermediário 1)"
    **Contexto:** 
...
!!! question "4 - 1. Entendendo a Batalha (Intermediário 2)"
    **Contexto:** 
...
!!! question "5 - 2. Como isso afeta o Compilador C/C++? (Desafio)"
    **Contexto:** 
...
[:octicons-light-bulb-24: Ver Solução e Explicação Detalhada](solucao-04.md){ .md-button .md-button--primary }
