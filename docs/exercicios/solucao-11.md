...
!!! success "Solução da Questão 1 - 1. Multi-Core (Múltiplos Núcleos) (Básico 1)"
...
!!! success "Solução da Questão 2 - 2. Hyper-Threading (SMT - Symmetrical Multi-Threading) (Básico 2)"
    **Explicação Detalhada do Assunto:**
...
!!! success "Solução da Questão 3 - 3. GPUs: O Paralelismo Maciço (Intermediário 1)"
    **Explicação Detalhada do Assunto:**
...
!!! success "Solução da Questão 5 - 1. Multi-Core (Múltiplos Núcleos) (Desafio)"
    **Explicação Detalhada do Assunto:**
