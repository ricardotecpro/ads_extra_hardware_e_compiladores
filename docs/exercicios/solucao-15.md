...
!!! success "Solução da Questão 1 - 1. System Calls (O Pedágio do Kernel) (Básico 1)"
...
!!! success "Solução da Questão 2 - 2. Interrupções vs Polling (Básico 2)"
    **Explicação Detalhada do Assunto:**
...
!!! success "Solução da Questão 3 - 3. DMA (Memória com Acesso Direto) (Intermediário 1)"
    **Explicação Detalhada do Assunto:**
...
!!! success "Solução da Questão 5 - 1. System Calls (O Pedágio do Kernel) (Desafio)"
    **Explicação Detalhada do Assunto:**
