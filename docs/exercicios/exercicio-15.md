...
!!! question "1 - 1. System Calls (O Pedágio do Kernel) (Básico 1)"
    **Contexto:** 
...
!!! question "2 - 2. Interrupções vs Polling (Básico 2)"
    **Contexto:** 
...
!!! question "3 - 3. DMA (Memória com Acesso Direto) (Intermediário 1)"
    **Contexto:** 
...
!!! question "5 - 1. System Calls (O Pedágio do Kernel) (Desafio)"
    **Contexto:** 
