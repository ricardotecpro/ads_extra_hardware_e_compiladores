...
!!! question "1 - 1. HDD (Hard Disk Drive) vs SSD (SATA) (Básico 1)"
    **Contexto:** 
...
!!! question "2 - 2. NVMe (O Limite PCIe) (Básico 2)"
    **Contexto:** 
...
!!! question "3 - 3. IOPS - A Métrica Real do Servidor (Intermediário 1)"
    **Contexto:** 
...
!!! question "5 - 1. HDD (Hard Disk Drive) vs SSD (SATA) (Desafio)"
    **Contexto:** 
