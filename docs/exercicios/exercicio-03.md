...
!!! question "1 - 1. O Triângulo de Ouro: ALU, CU e Registradores (Básico 1)"
    **Contexto:** 
...
!!! question "2 - 2. O Ciclo de Instrução (Fetch-Decode-Execute) (Básico 2)"
    **Contexto:** 
...
!!! question "3 - 3. Pipeline e Previsão de Desvio (Branch Prediction) (Intermediário 1)"
    **Contexto:** 
...
!!! question "5 - 1. O Triângulo de Ouro: ALU, CU e Registradores (Desafio)"
    **Contexto:** 
