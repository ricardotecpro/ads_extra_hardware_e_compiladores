...
!!! question "1 - 1. Cache Hit e Cache Miss (Básico 1)"
    **Contexto:** 
...
!!! question "2 - 2. Localidade Espacial vs Temporal (Básico 2)"
    **Contexto:** 
...
!!! question "3 - 3. False Sharing e Lógica Invertida (A Morte do C++) (Intermediário 1)"
    **Contexto:** 
...
!!! question "4 - 1. Cache Hit e Cache Miss (Intermediário 2)"
    **Contexto:** 
...
!!! question "5 - 2. Localidade Espacial vs Temporal (Desafio)"
    **Contexto:** 
