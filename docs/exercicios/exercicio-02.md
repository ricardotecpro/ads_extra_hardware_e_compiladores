...
!!! question "1 - 1. Sistema Binário e Hexadecimal (Básico 1)"
    **Contexto:** 
...
!!! question "2 - 2. Inteiros com e sem Sinal (Unsigned) (Básico 2)"
    **Contexto:** 
...
!!! question "3 - 3. Ponto Flutuante (IEEE 754) (Intermediário 1)"
    **Contexto:** 
...
!!! question "5 - 1. Sistema Binário e Hexadecimal (Desafio)"
    **Contexto:** 
...
[:octicons-light-bulb-24: Ver Solução e Explicação Detalhada](solucao-02.md){ .md-button .md-button--primary }
